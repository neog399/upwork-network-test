...
public class NetworkDisjointSetImplTest {
    ...
    public void cannotConnectTwoNodesIfTheFirstOneIsNotPresentInTheNetwork() {
        ...
        Network network = new NetworkDisjointSetImpl(3);
        network.connect(0, 1);
    }
    ...
    public void directConnectionsAreProperlyDiscovered() {
        Network network = new NetworkDisjointSetImpl(8);
        network.connect(1, 2);
        network.connect(1, 6);
        network.connect(2, 4);
        network.connect(2, 6);
